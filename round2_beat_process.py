...
if __name__ == '__main__':
    ...
    base_dir = config.round2_train_dir  # r"./tcdata/hf_round2_train/"
    beat_dir = config.round2_beat_dir  # r"./tcdata/hf_round2_beat_500/"

    test_base_dir = config.round2_test_dir # r"./tcdata/hf_round2_testB/"
    test_beat_dir = config.round2_test_beat_dir #r"./tcdata/hf_round2_test_beat_500/"

    if not os.path.exists(test_beat_dir): 
        os.makedirs(test_beat_dir) 

    extract_median_beat(base_dir,beat_dir)
    extract_median_beat(test_base_dir,test_beat_dir)